...
class UIUserNewFlight:
    ...
    def _initialize_new_flight_fields(self):
        ...
        plane_label.grid(column=0, row=5, sticky=constants.E)
        ...
        self._new_flight_plane_entry.grid(column=1, row=5)
